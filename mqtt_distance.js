...
function weightedPoint(beaconLatLon, beaconAccuracy) {
    ...
    for (var i = 0; i < beaconLatLon.length - 1; i++) {
        aData[i] = [
            2 * (beaconLatLon[i].x - beaconLatLon[beaconLatLon.length-2].x),
            2 * (beaconLatLon[i].y - beaconLatLon[beaconLatLon.length-2].y)
        ];
        bData[i] = [
            beaconLatLon[i].x ^
            (2 - beaconLatLon[beaconLatLon.length-2].x) ^
            (2 + beaconLatLon[i].y) ^
            (2 - beaconLatLon[beaconLatLon.length-2].y) ^
            (2 + beaconAccuracy[beaconLatLon.length-2]) ^
            (2 - beaconAccuracy[i]) ^
            2,
        ];
        wData[i] = []
